...
Class Latest_posts_footer_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-latest-posts-footer', 'Beakai Footer Posts Image', array(
			'description'	=> 'Latest Post Widget by Beakai'
		));
	}
				...
				?>
		            <div class="signle-blog-feeds mb-15">
		                ...
		                <div class="blog-feeds-thumb">
		                	<?php $featured_img_url = get_the_post_thumbnail_url(get_the_ID(),array(120,92)); ?>
		                    <a href="<?php the_permalink(); ?>"><img src="<?php print esc_url($featured_img_url); ?>" alt="img"></a>
		                </div>
		            	<?php endif; ?>
		                <div class="blog-feeds-text">
		                    <h5 class="widget-posts-title"><a href="<?php the_permalink(); ?>"><?php print wp_trim_words(get_the_title(), 6, ''); ?></a></h5>
