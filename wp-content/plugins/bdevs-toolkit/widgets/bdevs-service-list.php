...
Class Latest_Services_List_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-services-cats', 'Beakai Services List', array(
			'description'	=> 'Beakai Services List'
		));
	}
					...
					while( $q->have_posts() ):$q->the_post();
			            ...
			            <li>
			                <a href="<?php the_permalink(); ?>">
								<div class="more-service-icon"><i class="<?php echo esc_attr($icon_id); ?>"></i></div>
