...
class CTA extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('title', 'class', 'white-color bdevs-el-title');
        $this->add_render_attribute('title3', 'class', 'section-title d-block bdevs-el-title');
        ...
        $this->add_render_attribute('button', 'class', 'bt-btn bdevs-el-btn');
...
?>
        ...
        <?php else: ?>
            ...
            <section class="cta-area pos-rel pt-115 pb-120 bdevs-el-content bdevs-el-bg">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="cta-text text-center">
                                <div class="section-title pos-rel mb-50">
                                    <div class="section-text section-text-white pos-rel">
                                        <?php if ($settings['sub_title']) : ?>
                                            <h5 class="sub-title bdevs-el-sub-title">
