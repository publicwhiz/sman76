...
class Pricing_Table extends BDevs_El_Widget
{
    ...
    protected function register_style_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .single-slide-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('button_text', 'class', 'bt-btn transparent bdevselement-pricing-table-btn');
        ...
        $price_active_class = !empty($settings['show_bg_image']) ? 'active bg_img' : 'no-overlay';
        $price_overlay_active = !empty($settings['show_bg_image']) ? "data-overlay='94'" : "data-overlay='0'";

?>


        <div class="single-pricing-box single-slide-content <?php echo esc_attr($price_active_class); ?>" data-overlay="<?php echo esc_attr($price_overlay_active); ?>" data-background="<?php echo esc_url($bg_image); ?>">
            ...
            <div class="pricing-head">
                ...
                <?php endif; ?>
                <h2 <?php $this->print_render_attribute_string('price'); ?>>
                    <span class="bdevselement-pricing-table-currency"><?php echo esc_html($currency); ?></span><?php echo bdevs_element_kses_basic($settings['price']); ?>
                </h2>
            ...
            <div class="pricing-list mb-40">
                ...
                <?php if (is_array($settings['features_list'])) : ?>
                    <ul class="pricing-item bdevselement-pricing-table-body bdevselement-pricing-table-features-list">
                        ...
                        ?>
                            <li class="<?php echo esc_attr('elementor-repeater-item-' . $feature['_id']); ?>">
                                <span class="bdevselement-pricing-table-features-list" <?php $this->print_render_attribute_string($name_key); ?>>
                                    <?php echo bdevs_element_kses_intermediate($feature['text']); ?></span>
