    ...
    protected function register_style_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-expert-box:hover' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .single-expert-box:focus' => 'background-color: {{VALUE}};',
                ],
                'style_transfer' => true,
            ]
        );
                        ...
                        <?php if ($settings['show_profiles'] && is_array($settings['profiles'])) : ?>
                            <div class="bdevs-member-links">
                                ...
                                foreach ($settings['profiles'] as $profile) :
                                    ...
                                    printf(
                                        '<a target="_blank" rel="noopener" data-tooltip="hello" href="%s" class="elementor-repeater-item-%s comments-btn"><i class="%s" aria-hidden="true"></i></a>',
                                        $url,
