...
$beakai_video_url = function_exists('get_field') ? get_field( 'fromate_style' ) : NULL;
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox post format-image mb-50'); ?>>
        ...
        if( has_post_thumbnail() ): ?>
            <div class="postbox__video mb-30">
                ...
                <a class="popup-video video-btn" href="<?php print esc_url($beakai_video_url); ?>"><i class="fas fa-play"></i></a>
                <div class="blog-tags">
