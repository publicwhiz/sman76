...
<div class="col-lg-4 col-md-6 grid-item">
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox post format-image mb-40'); ?>>
        ...
        if(!empty( $massonary_img_id )): ?>
            <div class="postbox__thumb mb-25">
                <a href="<?php the_permalink(); ?>">
                    <img src="<?php print esc_url( $massonary_img ); ?>" alt="<?php print beakai_img_alt_text($massonary_img_id); ?>">
                </a>
            </div>
        <?php 
        endif; ?>
        ...
        <div class="postbox__text ">
            ...
            <!-- blog btn -->
            <?php 
                $beakai_blog_btn = get_theme_mod('beakai_blog_btn','Read More'); 
                $beakai_blog_btn_switch     = get_theme_mod('beakai_blog_btn_switch');  
            ?>

            <?php if(!empty($beakai_blog_btn_switch)) : ?>
            <div class="read-more mt-30">
                <a href="<?php the_permalink(); ?>" class="btn orange-bg bl-btn"><?php print esc_html($beakai_blog_btn); ?></a>
            </div>
            <?php endif; ?>
