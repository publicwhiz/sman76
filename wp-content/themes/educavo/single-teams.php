                ...
                <div class="row btm-row">
                        ...
                        <div class="inner-images">
                            ...
                            <div class="ps-informations">
                                ...
                                <ul class="personal-info">
                                  ...
                                  <?php if($email):?>
                                      <li class="email">
                                        <span><i class="glyph-icon educavoicon-email"> </i> </span>
                                  ...
                                  <?php if($phone):?>
                                    <li class="phone">
                                      <span><i class="glyph-icon educavoicon-call"></i></span> <?php echo esc_html( $phone ); ?>
                                </li>
                              <?php endif; ?>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="project-desc">  
                            ...
                            <?php if(empty($educavo_option['experience_title'])){ ?>
                                <h3 class="title-bg-gray padding-top"><?php esc_html_e( 'Experience & Activities','educavo' );?></h3> 
                            <?php } else { ?>
                                <h3 class="title-bg-gray padding-top"><?php  echo esc_html($educavo_option['experience_title']); ?></h3>
                            <?php } ?>              
                            <?php
                                the_content()
                            ?>
