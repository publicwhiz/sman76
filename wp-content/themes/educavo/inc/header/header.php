...
if(!empty($educavo_option['enable_global'])){	
    $header_style    =  !empty($educavo_option['header_layout']) ? $educavo_option['header_layout'] : '';
	...
	elseif(!empty($educavo_option['header_layout'])){		
...
if($rs_mouse_pointer != 'hide'){
	if(!empty($educavo_option['show_pointer']) || ($rs_mouse_pointer == 'show') ){
	    $pointer_localize_data = array(
	        'pointer_border' => $educavo_option['pointer_border'],
	        'border_width'   => $educavo_option['border_width'],
	        'pointer_bg'     => $educavo_option['pointer_bg'],
	        'diameter'       => $educavo_option['diameter'],
	        'scale'          => $educavo_option['scale'],
	        'speed'          => $educavo_option['speed'],     
	    );
	    wp_localize_script( 'educavo-main', 'pointer_data', $pointer_localize_data );
	}
}