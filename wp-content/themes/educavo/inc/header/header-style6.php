                        ...
                        <div class="col-cell header-quote">                         
                           <?php
                            ...
                            if($rs_show_cart != 'hide'){
                              if(!empty($educavo_option['wc_cart_icon']) || ($rs_show_cart == 'show') ) {
