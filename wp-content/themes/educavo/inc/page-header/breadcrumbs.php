<?php
    ...
    if(!empty($educavo_option['off_breadcrumb_all']) || $banner_hide =='hide'){ 
    ...
    if($post_meta_data == ''){
        if(!empty($educavo_option['page_banner_main']['url'])):
        $post_meta_data = $educavo_option['page_banner_main']['url'];
        endif;
    }  
